...
export type RuntimeInputRequest = {
  ...
  form: { layout: RuntimeInputLayout; fields: RuntimeInputField[] };
  variables: Readonly<Record<string, unknown>>;
  validationError?: string;
  signal: AbortSignal;
};

export type RuntimeRendererStart = { projectName: string; model: string; signal: AbortSignal; cancel(reason?: unknown): void };
export type RuntimeRendererResult = { status: "completed" | "paused"; output: unknown; elapsedMs: number };
